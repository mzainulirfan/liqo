            ...
            <table class="table table-centered table-nowrap mb-0 rounded">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="border-0">
                            <a href="#" class="d-flex align-items-center">
                                <img class="me-2 image image-small rounded-circle" alt="Image placeholder" src="<?= base_url(); ?>src/assets/img/flags/united-states-of-america.svg">
                    ...
                    <tr>
                        <td class="border-0">
                            <a href="#" class="d-flex align-items-center">
                                <img class="me-2 image image-small rounded-circle" alt="Image placeholder" src="<?= base_url(); ?>src/assets/img/flags/canada.svg">
                    ...
                    <tr>
                        <td class="border-0">
                            <a href="#" class="d-flex align-items-center">
                                <img class="me-2 image image-small rounded-circle" alt="Image placeholder" src="<?= base_url(); ?>src/assets/img/flags/united-kingdom.svg">
                    ...
                    <tr>
                        <td class="border-0">
                            <a href="#" class="d-flex align-items-center">
                                <img class="me-2 image image-small rounded-circle" alt="Image placeholder" src="<?= base_url(); ?>src/assets/img/flags/france.svg">
                    ...
                    <tr>
                        <td class="border-0">
                            <a href="#" class="d-flex align-items-center">
                                <img class="me-2 image image-small rounded-circle" alt="Image placeholder" src="<?= base_url(); ?>src/assets/img/flags/japan.svg">
                    ...
                    <tr>
                        <td class="border-0">
                            <a href="#" class="d-flex align-items-center">
                                <img class="me-2 image image-small rounded-circle" alt="Image placeholder" src="<?= base_url(); ?>src/assets/img/flags/germany.svg">
