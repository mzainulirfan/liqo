             ...
             <?php $uri = service('uri'); { ?>
                 <li class="nav-item <?= ($uri->getSegment(1) == '') ? 'active' : ''; ?> ">
                     <a href="<?= base_url(); ?>" class="nav-link">
                         ...
                         <span class="sidebar-text">Dashboard - <?= $uri->getSegment(1); ?></span>
                     </a>
                 </li>
                 ...
                 <li class="nav-item ">
                     ...
                     <div class="multi-level collapse   <?= ($uri->getSegment(1) == 'users') ? 'show' : ''; ?>" role="list" id="submenu-app" aria-expanded="false">
                         <ul class="flex-column nav">
                             <li class="nav-item <?= (($uri->getSegment(1) == 'users') && ($uri->getSegment(2) == null)) ? 'active' : ''; ?>">
                                 <a class="nav-link" href="<?= base_url(); ?>users">
                                     <span class="sidebar-text">All Users</span>
                                 </a>
                             </li>
                             <li class="nav-item <?= (($uri->getSegment(1) == 'users') && ($uri->getSegment(2) == 'create')) ? 'active' : ''; ?>">
                                 <a class="nav-link" href="<?= base_url(); ?>users/create">
